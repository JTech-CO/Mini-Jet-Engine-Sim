# ✈️ Mini Jet Engine Simulator

제트 엔진 시뮬레이터 웹 애플리케이션입니다. 실시간 물리 시뮬레이션, 오디오 피드백, 그리고 인터랙티브한 UI를 제공합니다.

<img width="3074" height="1636" alt="image" src="https://i.imgur.com/H82bmr2.png" />
...
2. **⬆️ TRIM UP**: 엔진 준비 상태로 전환
3. **🎚️ THROTTLE**: 스로틀 레버 조작 (0-100%)
4. **⬇️ TRIM DOWN**: 엔진 정지 및 냉각
...
**⚠️ 참고**: 오디오 기능을 사용하려면 사용자 인터랙션 후 오디오 컨텍스트를 시작해야 합니다 (MASTER 버튼 클릭).
